...
struct VM {
    ...
    execute_integer_comparison(OpType op, std::shared_ptr<Object> left, std::shared_ptr<Object> right);

    std::shared_ptr<Error>
    execute_binary_integer_operation(OpType op, std::shared_ptr<Object> left, std::shared_ptr<Object> right);

    std::shared_ptr<Error>
    execute_binary_string_operation(OpType op, std::shared_ptr<Object> left, std::shared_ptr<Object> right);
