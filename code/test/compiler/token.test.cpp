...
// declare Catch2 define a main function
...
TEST_CASE("Test Token Equivalence Semantics") {
    auto tok1 = Token{TokenType::IDENTIFIER, "five"};
    auto tok2 = Token{TokenType::IDENTIFIER, "ten"};
    auto tok3 = Token{TokenType::IDENTIFIER, "five"};
    ...
    tok2.literal = "five";
    tok4.type = TokenType::IDENTIFIER;
    tok5.type = TokenType::IDENTIFIER;
...
TEST_CASE("Test Token Copy Assignment") {
    auto tok1 = Token{TokenType::IDENTIFIER, "five"};
    auto tok2 = Token{TokenType::DECLARE, "declare"};
