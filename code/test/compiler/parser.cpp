...
std::shared_ptr<LetStatement> Parser::parseDeclarationStatement() {
    auto stmt = std::make_shared<LetStatement>(LetStatement{curToken});
...
std::shared_ptr<Expression> Parser::parseFunctionLiteral() {
    auto lit = std::make_shared<FunctionLiteral>(FunctionLiteral{curToken});
